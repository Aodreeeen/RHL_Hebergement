...
export default function RapportEstimation() {
  ...
  const { result, formData, adjustedPrice, bienPhoto, fromDashboard, estimationId, sectionVisibility, hiddenComparables } = location.state || {};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-slate-100 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <PDFDownloadLink
              document={<RapportPDF result={result} formData={formData} adjustedPrice={adjustedPrice} agentProfile={profile} bienPhoto={bienPhoto} sectionVisibility={visibility} hiddenComparables={hiddenComparables || []} />}
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
          ...
          <div className="hidden md:block">
            <PDFViewer
              ...
              showToolbar={false}
            >
              <RapportPDF result={result} formData={formData} adjustedPrice={adjustedPrice} agentProfile={profile} bienPhoto={bienPhoto} sectionVisibility={visibility} hiddenComparables={hiddenComparables || []} />
            </PDFViewer>
          </div>
